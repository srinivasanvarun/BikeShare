# clears variables -aaded by vishaka
...
################TODO normalize and mean here also- vishaka
...
####################TODO normalize and mean here also- vishaka ends
...
plt.suptitle('Univariate Non Linear Regression')
plt.plot(x, y,'ro')
